...
export default function Menu() {
  return (
    <div
      ...
      className="hidden w-[100%] max-w-[300px] flex-col text-center sm:hidden sm:w-[20%] sm:pl-10 sm:text-right lg:block lg:flex lg:w-[25%] lg:pl-0 lg:pr-8 lg2:w-[20%] xl:w-[17%]"
    >
      <GAGALENS
